...
const typeMap: any = {
    "Item": o([
        { json: "backgroundChartUpdatedAt", js: "backgroundChartUpdatedAt", typ: u(undefined, 3.14) },
        { json: "chartUpdatedAt", js: "chartUpdatedAt", typ: u(undefined, 3.14) },
        { json: "name", js: "name", typ: "" },
        { json: "priceStats", js: "priceStats", typ: u(undefined, r("PriceStats")) },
